...
An Urbit ship boots with a default Arvo `home` _desk_, or version-controlled directory:
...
This is just an HTML Hello World with a little vanilla JavaScript button:
...
!['Hello, Mars!' We're serving some HTML and JavaScript to the browser through Urbit.](https://cloud.githubusercontent.com/assets/13459143/23775012/5fc32fee-04db-11e7-9cad-116cca2528b8.gif)

A look at your browser dev tools shows our simple frontend code works:
...
If you look back in your `:dojo`, you should see that `%clay` recognized a change to your `tutorial.html` file:
...
The version-control number of your home desk should be incremented as a result of the change.

Reload the page, and with your browser dev tools Console open and your `:dojo` in sight, click the button!
...
<script src="">` tag just means, "your most current home directory", since everything is version-controlled through %clay.
...
var _urb = { "oryx": "bardys-ridmes-salser-napreg--watwer-ribmyn-midsul-digber", "user": "darlen-natleb-modwer-falrud--bisrev-haltyd-ralwex-dolmyn", "sein": "zod", "ixor": "morret-taspeg-ritlug-fortug", "ship": "darlen-natleb-modwer-falrud--bisrev-haltyd-ralwex-dolmyn", "auth": [ "darlen-natleb-modwer-falrud--bisrev-haltyd-ralwex-dolmyn" ] };
...
{ "oryx": "modtuc-diffus-ropdef-novluc--satlev-tomrut-lodres-digweg", "xyro": "hi. :)", "ship": "darlen-natleb-modwer-falrud--bisrev-haltyd-ralwex-dolmyn", "appl": "hood", "mark": "helm-hi", "wire": "/" }
...
<script src="/=home=/web/tutorial/main.js">
</script>
...
<script>
        ...
        var send = &#39;&#39;;
        send += &quot;<div class='send'>&quot;;
        send += &#39;<h3>Send a <code>:talk</code> post to your &#39; + station + &#39;, ~&#39; + window.urb.ship + &#39;!</h3>&#39;;
        send += &#39;<br />&#39;;
        ...
        function sendPost() {
            ...
            return send<code>:talk</code>Message(post, audience);
        }
    </script>
...
function sendPost() { var post = document.getElementById('post').value; var audience = document.getElementById('audience').value; return send`:talk`Message(post, audience); }

function uuid32() { var str = '0v'; str += Math.ceil(Math.random() _8) + '.'; for (i = j = 0; j <= 5; i = ++j) { _str = Math.ceil(Math.random()_ 10000000).toString(32); _str = ('00000' + _str).substr(-5, 5); str += _str + '.'; } serial = str.slice(0, -1); return serial; }

function send`:talk`Message(txt, audi) { var audience = {}; audience[audi] = { envelope: { visible: true, sender: null }, delivery: 'pending' };
...
[%ra-know-not ~.a-second-station] ~darlen_dolmyn:talk[]
...
$ git checkout -f 1.4 $ cp tutorial.html ~/mycomet/home/web && cp -r tutorial ~/mycomet/home/web
...
$ git checkout -f 1.5 $ cp tutorial.html ~/mycomet/home/web && cp -r tutorial ~/mycomet/home/web ```
